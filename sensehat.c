...
//
int read_PressTemp_sensehat(int *Pressure, int *Temp)
{
unsigned char ucTemp[8];
int rc, P, T;
...
{
    double heading = 180 * atan2(y,x)/M_PI; //convert raw data
    ...
    //printf("heading %7.3f \t Rawdata  MagnX=%d, MagnY=%d, MagnZ=%d\n", heading, x, y, z);
    return (heading);
}
