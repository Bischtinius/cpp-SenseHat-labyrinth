...
//
int read_PressTemp_sensehat(int *pPressure, int *pTemp);
...
//
int read_Magneto_sensehat(int *Mx, int *My, int *Mz);

//
// Read the Accel values for x/y/z
//
int read_Accel_sensehat(int *Ax, int *Ay, int *Az);

//
// Read the Gyro values for x/y/z
//
int read_Gyro_sensehat(int *Gx, int *Gy, int *Gz);
...
//
int init_sensehat(int iChannel);

//
// Returns the temperature and humidity
//
int read_HumTemp_sensehat(int *Temp, int *Humid);


//
//reutrns the heading calculated from raw data x,y
//
double read_Heading_sensehat(int x, int y);
